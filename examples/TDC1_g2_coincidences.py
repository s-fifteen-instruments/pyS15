#A sample Python script to collect timestamps from 2 input channels and perform a g2 time correlation histogram (with set integration time and time delay) between them.
