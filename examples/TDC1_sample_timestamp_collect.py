#A short example python script to use S-Fifteen Instruments TDC1 for collecting timestamps from four input channels into python variables. t1—t4 will hold the timestamps (in ns) for 4 different channels respectively. From these timestamps, any processing can be done
import numpy as np
